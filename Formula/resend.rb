class Resend < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/resend/resend-cli/releases/download/v2.11.0/resend-darwin-arm64.tar.gz"
      sha256 "019d36b4c1fd2bb59f5ba174cb6d33430f87dc55ebabfb185b4539617b9ca4e7"
    else
