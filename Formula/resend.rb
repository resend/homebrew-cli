class Resend < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/resend/resend-cli/releases/download/v2.16.0/resend-darwin-arm64.tar.gz"
      sha256 "da57598d602b6cdb703da85ec18cd4e587c41de06dbb558170115e12cf91f70a"
    else
